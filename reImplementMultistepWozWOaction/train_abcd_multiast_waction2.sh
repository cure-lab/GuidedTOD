...
# all
# export CUDA_VISIBLE_DEVICES=6,7
# python train.py --experiment_name abcdMultiASTWActionAll \
#  --model_name_or_path t5-small \
#   --do_train \
#   --do_eval \
#   --do_predict \
#   --num_train_epochs 100 \
#   --train_file ./data/processed/train_multiAST_abcd_waction_full.json \
#   --validation_file ./data/processed/dev_multiAST_abcd_waction_full.json \
#   --test_file ./data/processed/test_multiAST_abcd_waction_full.json \
#   --text_column input \
#   --summary_column target \
#   --per_device_train_batch_size 32 \
#   --per_device_eval_batch_size 32 \
...
#   # delete the saved model
# rm -rf results/abcdMultiASTWActionAll_input_target_t5-small/checkpoint-*