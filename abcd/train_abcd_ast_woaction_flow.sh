...
# rm -rf results/abcdASTWOActionFlow10P_input_target_t5-small/checkpoint-*
...
# delete the saved model
rm -rf results/abcdASTWOActionFlow30P_input_target_t5-small/checkpoint-*
...
# delete the saved model
rm -rf results/abcdASTWOActionFlowHalf_input_target_t5-small/checkpoint-*
...
# # delete the saved model
# rm -rf results/abcdASTWOActionFlowAll_input_target_t5-small/checkpoint-*