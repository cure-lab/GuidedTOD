...
def convert_intents_to_ast(dialogue_intents_w_values, original_dialogue: List, action_mappings: Dict, turn_intent: Dict, sample_states: Dict):
...
def parse_multiwoz_dataset_for_ast(raw_data: List, action_mappings: Dict, replacements: List):
    ...
    for sample in raw_data:
        ...
        ASTs = convert_intents_to_ast(intents_w_slots, original_dialogue, action_mappings, turn_intent, sample_states)
