...
#  --model_name_or_path results/abcdASTWMostPActionNoinitChainAll_input_target_t5-small \
#   --do_predict \
...
#   --test_file ./data/processed/train_AST_abcd_wmostpaction_chain_noinit_all.json \
#   --text_column input \
